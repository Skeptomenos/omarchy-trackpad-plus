...
- 2026-09-16: Palm scaffold merged (`palm/` template, README, test). Mac gestures ported: `fullscreen_up` plus `scratchpad_down`, schema 8, editor toggles, 8 new tests. Full Python suite passes (104). qmllint clean. qmltestrunner not installed locally. Next: live check on omarchy12, then panel wiring for palm.
